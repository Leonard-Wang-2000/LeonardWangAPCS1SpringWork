...
public class Spreadsheet implements Grid
{
	...
	public String processCommand(String command)
	{
		...
		if(command.contains("open")){
			System.out.print(readFromFile(splitCommand[1]));
		}
		if(command.contains("save")){
			System.out.println(writeToFile(splitCommand[1]));
		}
	...
	private String readFromFile(String filename){ 
	     ...
	     while(outputFile.hasNextLine()){
	    	 ...
	    	 SpreadsheetLocation b = new SpreadsheetLocation(splitAtCommas[0]);
	 		//assigns cell accordingly to distinct characteristics
	 		if(splitAtCommas[1].equals("PercentCell")){
	 			arrayOfStuff[b.getRow()][b.getCol()] = new PercentCell(Double.parseDouble(splitAtCommas[2])/100.0 + "%");
	 		} else if(splitAtCommas[1].equals("TextCell")){
	 			arrayOfStuff[b.getRow()][b.getCol()] = new TextCell(splitAtCommas[2]);
	 		} else if(splitAtCommas[1].equals("FormulaCell")){
	 			arrayOfStuff[b.getRow()][b.getCol()] = new FormulaCell(splitAtCommas[2]);
	 		} else if(splitAtCommas[1].equals("ValueCell")){
	 			arrayOfStuff[b.getRow()][b.getCol()] = new ValueCell(splitAtCommas[2]);
	 		}
	     }
	     outputFile.close();
	     return getGridText();
